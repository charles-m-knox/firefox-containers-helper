...
const LI_BASE =
  'list-group-item d-flex justify-content-space-between align-items-center container-list-item m-0 p-2';
 ...
 * items.
 */
export const CLASSES_CONTAINER_LI_EMPTY =
  'list-group-item d-flex justify-content-space-between align-items-center';
